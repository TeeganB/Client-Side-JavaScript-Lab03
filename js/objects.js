...
var person = {
    ...
    */
    ...
    interests: ["swimming", "dancing", "singing", "gaming"],
    ...
    bio: function() {
        return `The interests of ${this.name.firstName} ${this.name.lastName}, of age ${this.age}, living in the city of ${this.address.city} are ${this.interests}`;
    }
