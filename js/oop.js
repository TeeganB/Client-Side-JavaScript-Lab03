...
let person2 = new Person("P1","LP1",18,["swimming","reading","gaming"]);
...
function Hamburger(bun, vegetable, cheese, sauce, pattie, numPatties, extras) {
    this.bun = bun;
    ...
    this.description = function () {
        return `This is a ${numPatties}-patty ${pattie} burger on a ${bun} bun with ${cheese} cheese, ${sauce} sauce, and ${vegetable}.`;
    };
}

// Example usage:
let myBurger = new Hamburger("sesame", "lettuce and tomato", "cheddar", "BBQ", "beef", 2, ["pickles", "hot peppers"]);
console.log(myBurger.description());

/* STEP 2: Instatiate a coffee based on the above constructor function */
let teeganCoffee = new Coffee("large", false, 3, 3);
output.textContent = teeganCoffee.description();
