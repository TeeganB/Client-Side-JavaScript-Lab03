    ...
    serveIt(){
        ...
        switch(this.size) {
            case "small": 
                ...
                break;//<img src= "images/coffee-cup.svg" height=100>
            case "medium":
...
let teeganCoffee = new Coffee("large", true);

let robertCoffee = new Coffee("medium", false);
...
let teeganLatte = new Latte("large", false, "2%");
